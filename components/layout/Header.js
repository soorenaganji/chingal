    ...
    <>
      <div className="w-full px-12 flex items-center justify-between h-[128px] py-6 border-b-2 dark:border-slate-700 bg-[#FBFDFE] dark:bg-[#020B1F] overflow-hidden ">
        ...
        <div className="flex items-center justify-center gap-8 flex-row-reverse overflow-hidden ">
          ...
          <div className={`flex items-center justify-center flex-row-reverse ${isInHome ? "" : "hidden"}  `} >
                    <input
            type="search"
...
<path d="M10.5 20.6687C4.85 20.6687 0.25 16.0687 0.25 10.4187C0.25 4.7687 4.85 0.168701 10.5 0.168701C16.15 0.168701 20.75 4.7687 20.75 10.4187C20.75 16.0687 16.15 20.6687 10.5 20.6687ZM10.5 1.6687C5.67 1.6687 1.75 5.5987 1.75 10.4187C1.75 15.2387 5.67 19.1687 10.5 19.1687C15.33 19.1687 19.25 15.2387 19.25 10.4187C19.25 5.5987 15.33 1.6687 10.5 1.6687Z" fill="#7E848E"/>
<path d="M21 21.6687C20.81 21.6687 20.62 21.5987 20.47 21.4487L18.47 19.4487C18.18 19.1587 18.18 18.6787 18.47 18.3887C18.76 18.0987 19.24 18.0987 19.53 18.3887L21.53 20.3887C21.82 20.6787 21.82 21.1587 21.53 21.4487C21.38 21.5987 21.19 21.6687 21 21.6687Z" fill="#7E848E"/>
</svg>
